...
export default function NewProduct() {
  ...
  const postURL = "http://localhost:4000/products";
                  ...
                  <Item sx={{ marginTop: 0 }}>
                      ...
                      <label htmlFor="contained-button-file">
                        ...
                        >
                          <input
                            ...
                            type="file"
                            onChange={featuredImageHandleChange}
                            sx={{ display: "none" }}
                          />
                          Featured Image
                        </Button>
                    ...
                    <Card sx={{ width: "100%", height: 180 }}>
                      <CardMedia
                        ...
                        height="100%"
                        width="100%"
                        src="http://www.friendlyautosale.net/application/modules/themes/views/default/assets/images/image-placeholder.png"
                        image={featuredImageFront}
                        alt=""
                        sx={{
                          cursor: "pointer",
